...
async def slash_command_inquirysetting(ctx,who:discord.Option(discord.Member,'誰に送信する？',Required=True)):
    ...
    inquiry_setting_embed.set_thumbnail(url=ctx.author.avatar)
    await ctx.respond(embed=inquiry_setting_embed)

@bot.slash_command(name='inquiry',description='このコマンドはサーバーの管理者もしくは、「inquirysetting」で決めたユーザーに対してお問い合わせすることができます。',guild_ids=[807953798894714960])
